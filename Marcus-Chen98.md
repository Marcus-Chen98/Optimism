...
**Optimism 当前所处阶段：Stage 1。Arb也到了**
...
### 2025.01.12
、、、
主网（OP Mainnet）：一个廉价且快速的以太坊 Layer 2 网络，与以太坊虚拟机（EVM）兼容。

智能合约：实现 OP Stack 核心逻辑和功能的智能合约，包括状态转换系统（STS）、欺诈证明者（FP）、状态承诺链（SCC）以及规范交易链（CTC）

### 2025.01.13

**OP 治理怎么如何将贡献对应成相应的价值**

- impact=profit，真的有合理的衡量机制么，代币还是依靠稳定币，也可说是美元去标记其价格，什么时候能反过来定价。
